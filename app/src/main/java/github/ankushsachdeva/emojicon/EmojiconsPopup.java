...
import com.umbrellaapps.urdu.keyboard.SessionManager;
...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
	...
	private View createCustomView() {
		...
		if (!keyboardBg.equals("white")) {
			int keyboardBgId = mContext.getResources().getIdentifier(keyboardBg, "drawable", mContext.getPackageName());
			view.setBackgroundResource(keyboardBgId);
		} else {
		...
		view.findViewById(R.id.btn_close_popup).setOnClickListener(new OnClickListener() {
			@Override
